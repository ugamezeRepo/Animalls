			...
			<section id="infoSection">
				...
				<div class="container">
					...
					<div class="mb-2">
						...
						<button class="btn btn-primary" id="sendAuthEmailBtn" disabled>인증번호 받기</button>
					</div>
	...
	<script>
		...
		id.addEventListener("blur", ()=>{
			...
			if (!reg_memberId.test(id.value)) {
				...
				isValid.memberId = true;
			}
			fetch("${pageContext.request.contextPath}/member/check_memberId.jsp?memberId=" + id.value)
			.then(res => res.json())
			.then(data => {
